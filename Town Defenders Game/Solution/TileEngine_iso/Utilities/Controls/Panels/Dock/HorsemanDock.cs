...
{
    public class HorsemanDock:DisplayDock
    {
        private Horseman Context;

        public HorsemanDock(Vector2 position, ControlManager controlManager) 
            : base(position, controlManager)
        {
            Thumbnail = new ImageButton96(
                 GameGraphics.GetTexture("horseman_96").SourceTexture, ThumbnailPosition);
