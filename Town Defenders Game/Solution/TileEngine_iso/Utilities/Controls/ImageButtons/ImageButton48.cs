...
{
    public class ImageButton48 : PictureBox
    {
        ...
        public ImageButton48(Texture2D image, Vector2 position)
            : base(image, new Rectangle((int)position.X, (int)position.Y, 48, 48),
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            //draw border..
            spriteBatch.Draw(
                  GameGraphics.GetTexture("button_border_48").SourceTexture,
            ...
            if (HasFocus)
            {
                //draw overlay..
                spriteBatch.Draw(
                      GameGraphics.GetTexture("button_press_48").SourceTexture,
                      new Vector2(DestinationRectangle.X, DestinationRectangle.Y),
                      SourceRectangle,
                      Color.White,
                      0.0f,
